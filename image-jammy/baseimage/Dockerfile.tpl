...
RUN apt-get update --fix-missing \
    ...
    && rm -r /root/.cache/pip \
    && pip3 install --timeout=3600 future mysqlclient Pillow pylibmc captcha markupsafe==2.0.1 jinja2 sqlalchemy==1.4.3 django-pylibmc django-simple-captcha pyjwt pycryptodome==3.12.0 \
    && rm -r /root/.cache/pip \
    # Cleanup apt caches
