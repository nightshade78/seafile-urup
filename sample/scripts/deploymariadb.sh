...
docker run -d --name mariadb -v /srv/mariadb/data/:/var/lib/mysql -p 3306:3306 -e MYSQL_LOG_CONSOLE=true -e MARIADB_AUTO_UPGRADE=true --restart=unless-stopped -u $USERID:$GROUPID mariadb:10
